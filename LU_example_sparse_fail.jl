...
println("Number of elements differening between L_NuNv calculated by MATLAB versus full matrix in julia: ", count)
...
# @show "MATLAB,julia full array, julia sparse array"
# for i = 1:10
#     for j = 1:10       
#         println(L_NuNv_sparse_matlab[i,j]," ",L_NuNv_full[i,j]," ",L_NuNv_sparse[i,j])
#     end
# end
